      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto prose lg:prose-lg">
            <ul>
              <li>Protect your primary email address from spam and unwanted newsletters</li>
              <li>Stay anonymous when signing up for online services</li>
              <li>Test website functionalities without using your real email</li>
              <li>Avoid email marketing and promotional clutter</li>
              <li>Maintain privacy during online transactions</li>
            </ul>
          </div>
        </div>
      </section>
